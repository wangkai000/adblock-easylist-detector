...
const entries = [
  {
    ...
    outputs: [
      ...
      {
        file: 'dist/adblock-easylist-detector.umd.js',
        format: 'umd',
        name: 'AdblockEasylistDetector',
        sourcemap: true,
        exports: 'named',
      },
    ],
  },
  {
    ...
    outputs: [
      ...
      {
        file: 'dist/detector.umd.js',
        format: 'umd',
        name: 'AdblockEasylistDetector_Engine',
        sourcemap: true,
        exports: 'named',
      },
    ],
  },
  {
    ...
    outputs: [
      ...
      {
        file: 'dist/resource-generator.umd.js',
        format: 'umd',
        name: 'AdblockEasylistDetector_ResourceGen',
        sourcemap: true,
        exports: 'named',
      },
    ],
  },
  {
    ...
    outputs: [
      ...
      {
        file: 'dist/bait-detector.umd.js',
        format: 'umd',
        name: 'AdblockEasylistDetector_Bait',
        sourcemap: true,
        exports: 'named',
      },
    ],
  },
  {
    ...
    outputs: [
      ...
      {
        file: 'dist/callback.umd.js',
        format: 'umd',
        name: 'AdblockEasylistDetector_Callback',
        sourcemap: true,
        exports: 'named',
      },
    ],
...
async function build() {
  ...
  try {
    ...
    await bundle.write({
      file: 'dist/adblock-easylist-detector.umd.min.js',
      format: 'umd',
      name: 'AdblockEasylistDetector',
      exports: 'named',
    });
